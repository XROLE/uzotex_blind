          ...
          Form(
            ...
            child: ListView(
              ...
              children: [
                SizedBox(
                  height:
                      ResponsiveHeigthAndWidth.getHeigth(0.05, 0.12, context),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: decorateInpute('Unit Name'),
                        onChanged: (value) {
                          setState(() {
                            _error = '';
                          });
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        controller: nameController,
                        style: TextStyle(fontSize: 18),
                        decoration: decorateInpute('Category'),
                        onChanged: (value) {
                          setState(() {
                            _error = '';
                          });
                ...
                SizedBox(
                  height:
                      ResponsiveHeigthAndWidth.getHeigth(0.02, 0.08, context),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                ...
                SizedBox(
                    height:
                        ResponsiveHeigthAndWidth.getWidth(0.10, 0.06, context)),
                _showSpinner
